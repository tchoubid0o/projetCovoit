...
public class RepondreServlet extends GlobalInformationsServlet{
	...
	public void postRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if(request.getParameter("proposerForm") != null){
			String idAnnonceRecherche = request.getParameter("idAnnonceRecherche");
			request.setAttribute("idAnnonceRecherche", idAnnonceRecherche);
		}
		else{
			String idAnnonceRecherche = request.getParameter("idAnnonceRecherche");
